...
% 
% legend('Conversion (adiabatic)', 'Conversion (isothermal)', 'Selectivity (adiabatic)', 'Selectivity (isothermal)', 'location', 'southeast')
% title({'Conversion and Selectivity achieved in a 10 m^{3} reactor', 'with steam-ethylbenzene ratio of 12 for both adiabatic and isothermal reactors'})
% 
% set(gca,'fontname','times')

%print('Part4a.png', '-dpng', '-r1000')
...
title('Temperature variation along the reactor')
legend('Inlet 800 K', 'Inlet 830 K', 'Inlet 870 K', 'Inlet 945 K', 'Inlet 1100 K', 'location', 'southwest')

%print('Part4aExtension.png', '-dpng', '-r1000')